...
import { createClient } from '@/utils/supabase/client' // Pastikan import client ini ada
...
export default function ResetPasswordPage() {
    ...
    // 2. Animasi Entrance (Hanya jalan setelah security check selesai)
    useEffect(() => {
        if (!isChecking) {
    ...
    // TAMPILAN LOADING SEBELUM CEK SELESAI
    if (isChecking) {
        return (
